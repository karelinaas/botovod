# фильтр может вернуть не только True, но и любое значение, которое может быть приведено к True
# т.е., можно не только получить данные о том, что фильтр пройден, но и передать это значение как аргумент в хэндлер
